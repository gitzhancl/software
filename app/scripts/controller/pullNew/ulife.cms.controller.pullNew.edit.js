...
define([
    ...
    function (app, services, BizConfig, MenuConfig,  cmsPullNewCreateOrEdit, cmsPullNewGet, cmsPullNewPublishOrCancel) {

        cmsPullNewCreateOrEdit.injectTo(app);
        cmsPullNewGet.injectTo(app);
        cmsPullNewPublishOrCancel.injectTo(app);

        app.controller('PullNewEditCtrl', ['$scope', '$location', '$route', '$filter',
            ...
            function ($scope, $location, $route, $filter,  cmsPullNewCreateOrEditService, cmsPullNewGetService, cmsPullNewPublishOrCancelService,
                      validService) {
                ...
                $scope.pullNew.endTime = $scope.pullNew.viewEndTime;
                ...
                $scope.btns = {
                    "save": function () {
                        if (!validService.valid($scope.pullNewEditForm)) {
                            return;
                        }
