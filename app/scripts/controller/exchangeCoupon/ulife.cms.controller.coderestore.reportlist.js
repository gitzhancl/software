...
define([
        ...
        'ulife.api.ticket.coderestore.reportlist',
    ...
    function(app, services, BizConfig, MenuConfig, codeReStoreList) {

        codeReStoreList.injectTo(app);

        app.filter('codeReStoreDataTime', function () {
            return function (val) {
                if(val ==""){
                    return val;
                }else{
        ...
        app.controller('codeReStoreListCtrl', ['$scope', '$location', '$route',
            'ticketCoderestoreReportlistService',
            'authorityService',
            function($scope, $location, $route, ticketCoderestoreReportlistService) {
                ...
                $scope.searchPage = {
                    ...
                    "getData": function(actionType) {
                        ...
                        //获取页面列表
                       return $.when(ticketCoderestoreReportlistService.sendRequest(tmpParams))
