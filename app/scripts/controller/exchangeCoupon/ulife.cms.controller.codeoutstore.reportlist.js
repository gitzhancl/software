...
define([
    ...
    function(app, services, BizConfig, MenuConfig, codeOutStoreList) {

        codeOutStoreList.injectTo(app);
        ...
        app.controller('codeOutStoreListCtrl', ['$scope', '$location', '$route',
            'ticketCodeoutstoreReportlistService',
            'authorityService',
            function($scope, $location, $route, ticketCodeoutstoreReportlistService) {
                ...
                $scope.searchPage = {
                    ...
                    "getData": function(actionType) {
                        ...
                        //获取页面列表
                       return $.when(ticketCodeoutstoreReportlistService.sendRequest(tmpParams))
