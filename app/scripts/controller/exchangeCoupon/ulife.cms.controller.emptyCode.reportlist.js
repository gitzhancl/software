...
define([
        ...
        'ulife.api.ticket.emptycode.reportlist',
    ...
    function(app, services, BizConfig, MenuConfig, emptycodeList) {

        emptycodeList.injectTo(app);
        

        app.controller('emptyCodeListCtrl', ['$scope', '$location', '$route',
            'ticketEmptycodeReportlistService',
            'authorityService',
            function($scope, $location, $route, ticketEmptycodeReportlistService) {
                ...
                $scope.searchPage = {
                    ...
                    "getData": function(actionType) {
                        ...
                        //获取页面列表
                       return $.when(ticketEmptycodeReportlistService.sendRequest(tmpParams))
