...
define([
    ...
    function(app, $, moment) {
        ...
        app.service('UploadBase', ['$http', '$q', '$timeout', function ($http, $q, $timeout) {
            var upload = this;
        ...
        app.service('Upload', ['$parse', '$timeout', '$compile', '$q', 'UploadExif', function ($parse, $timeout, $compile, $q, UploadExif) {
        ...
        app.directive('ngfSelect', ['$parse', '$timeout', '$compile', 'Upload', function ($parse, $timeout, $compile, Upload) {
            var generatedElems = [];
        ...
        (function () {
            ...
            app.service('UploadDataUrl', ['UploadBase', '$timeout', '$q', function (UploadBase, $timeout, $q) {
            ...
            app.directive('ngfSrc', ['Upload', '$timeout', function (Upload, $timeout) {
                return {
                    restrict: 'AE',
            ...
            /** @namespace attr.ngfNoObjectUrl */
            app.directive('ngfBackground', ['Upload', '$timeout', function (Upload, $timeout) {
                return {
                    restrict: 'AE',
                    link: function (scope, elem, attr) {
            ...
            /** @namespace attr.ngfNoObjectUrl */
            app.directive('ngfThumbnail', ['Upload', '$timeout', function (Upload, $timeout) {
                return {
                    restrict: 'AE',
                    link: function (scope, elem, attr) {
            ...
            app.filter('ngfDataUrl', ['UploadDataUrl', '$sce', function (UploadDataUrl, $sce) {
        ...
        app.service('UploadValidate', ['UploadDataUrl', '$q', '$timeout', function (UploadDataUrl, $q, $timeout) {
        ...
        app.service('UploadResize', ['UploadValidate', '$q', function (UploadValidate, $q) {
        ...
        (function () {
            app.directive('ngfDrop', ['$parse', '$timeout', '$location', 'Upload', '$http', '$q',
            ...
            app.directive('ngfDropAvailable', ['$parse', '$timeout', 'Upload', function ($parse, $timeout, Upload) {
...
// customized version of https://github.com/exif-js/exif-js
        app.service('UploadExif', ['UploadResize', '$q', function (UploadResize, $q) {
